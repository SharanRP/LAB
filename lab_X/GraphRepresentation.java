                ...
                switch (choice) {
                    ...
                    case 5:
                        ...
                        for (Vertex<String> vertex : graph.getVertices().values()) {
                            System.out.print(vertex.key + ": ");
                            for (Vertex<String> adjacentVertex :
                                    graph.getAdjacencyMap().get(vertex).keySet()) {
                                Edge<String> edge =
                                        graph.getAdjacencyMap().get(vertex).get(adjacentVertex);
                                System.out.print(adjacentVertex.key + "(" + edge.key + ")1");
                            }
                            System.out.println();
                        }
                        break;
